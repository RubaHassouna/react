...
function Movie() {
  return (
    <div className="movie-page">
      ...
      <div id="main-heading"><h1>Favourite Movie</h1> </div>
      <div className="d-flex flex-row flex-wrap gap-5">
        <Card style={{ width: "15rem", height: "" }}>
          ...
          <Card.Body className="card-body">
            ...
            <Card.Text>
              <p>
                is a series of seven fantasy novels written by British author J.
                K. Rowling.
              </p>
            </Card.Text>
        ...
        <Card style={{ width: "15rem", height: "" }}>
          ...
          <Card.Body className="d-flex flex-row flex-wrap gap-5 justify-content-center">
            ...
            <Card.Text>
              <p>
                is a 1999 science fiction action film written and directed by
                the Wachowskis.
              </p>
            </Card.Text>
             <CardLink href="http://www.harrypotter.com">
        ...
        <Card style={{ width: "15rem", height: "" }}>
          ...
          <Card.Body className="d-flex flex-row flex-wrap gap-5 justify-content-center">
            ...
            <Card.Text>
              <p>
                is a trilogy of epic fantasy adventure films directed by Peter
                Jackson, based on the novel.
              </p>
            </Card.Text>
        ...
        <Card style={{ width: "15rem", height: "" }}>
          ...
          <Card.Body className="d-flex flex-row flex-wrap gap-5 justify-content-center">
            ...
            <Card.Text>
              <p>
              is a 2012 American dystopian 
              action film directed by Gary Ross
              </p>
            </Card.Text>
            <CardLink href="http://www.google.com">
            <Button variant="danger">Watch Me</Button>
        ...
        <Card style={{ width: "15rem", height: "" }}>
          ...
          <Card.Body className="d-flex flex-row flex-wrap gap-5 justify-content-center">
            ...
            <Card.Text>
              <p>
              is a 2014 American dystopian science
               fiction action film directed by Neil Burger
              </p>
            </Card.Text>
           <CardLink href="http://www.google.com">
           <Button variant="danger">Watch Me</Button>
